<x-app-layout>
    ...
    <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
        <p class="px-4 pb-12 text-lg text-gray-600 sm:px-0 sm:text-2xl">Edit {{ $company->name }}</p>

        <div class="p-4 bg-white border sm:p-8">
            <div class="w-full">
                    <form method="post" action="{{ route('companies.update', $company->slug) }}" class="mt-6 space-y-6"
                        ...
                        <div>
                            ...
                            <x-text-input placeholder="Your company name" id="name" name="name" type="text"
                                class="block w-full mt-1" :value="old('name', $company->name)" autofocus autocomplete="name" />
                        ...
                        <div>
                            ...
                            <x-text-input placeholder="Your company email" id="email" name="email" type="email"
                                class="block w-full mt-1" :value="old('email', $company->email)" autofocus autocomplete="email" />
                        ...
                        <div>
                            ...
                            <x-text-input placeholder="Your company address" id="address" name="address"
                                type="text" class="block w-full mt-1" :value="old('address', $company->address)" autofocus
                        ...
                        <div class="sm:gap-2 sm:flex">
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company city" id="city" name="city"
                                    type="text" class="block w-full mt-1" :value="old('city', $company->city)" autofocus
                                    autocomplete="city" />
                        ...
                        <div class="sm:gap-2 sm:flex">
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company postcode" id="postcode" name="postcode"
                                    type="number" class="block w-full mt-1" :value="old('postcode', $company->postcode)" autofocus
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company industry" id="industry" name="industry"
                                    type="text" class="block w-full mt-1" :value="old('industry', $company->industry)" autofocus
                        ...
                        <div class="sm:gap-2 sm:flex">
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company phone" id="phone" name="phone"
                                    type="number" class="block w-full mt-1" :value="old('phone', $company->phone)" autofocus
                                    autocomplete="phone" />
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company foundation year" id="founded" name="founded"
                                    type="date" class="block w-full mt-1" :value="old('founded', $company->founded)" autofocus
                        ...
                        <div class="sm:gap-2 sm:flex">
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company website" id="website" name="website"
                                    type="url" class="block w-full mt-1" :value="old('website', $company->website)" autofocus
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <x-text-input placeholder="Your company foundation year" id="revenue"
                                    name="revenue" type="number" class="block w-full mt-1" :value="old('revenue', $company->revenue)"
                        ...
                        <div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input placeholder="Your company logo" id="logo" name="logo"
                                    type="file" />
                        ...
                        <div class="w-full sm:w-1/2">
                            ...
                            <x-text-input placeholder="Your company employees number" id="employees" name="employees"
                                type="number" class="block w-full mt-1" :value="old('employees', $company->employees)" autofocus
                        ...
                        <div class="mb-4">
                            ...
                            <div>
                                <textarea id="bio" name="bio" placeholder="Tell us about this company!">{{ old('bio', $company->bio) }}</textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <x-text-input placeholder="Your company slug" id="slug" name="slug"
                                type="text" class="block w-full mt-1" :value="old('slug', $company->slug)" autofocus
                                autocomplete="slug" />
